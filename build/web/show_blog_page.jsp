<%-- 
    ...
    Created on : 14 Jul, 2021, 4:30:25 PM
    Author     : prachi
--%>
...
<html>
    <head>
        ...
        <title><%= p.getpTitle()%>|| TechBlog  by learn Code  with prachi </title>
        <!--css-->
        ...
        <div id="fb-root"></div>
        <script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_GB/sdk.js#xfbml=1&version=v11.0&appId=267579694713056&autoLogAppEvents=1" nonce="3iIuZ2qw"></script>
                            ...
                            <div class="row my-3 row-user">
                                ...
                                <div class="col-md-4">
                                    <p class="post-date">
                                        ...
                                        <p class="post-content"><%=p.getpSubContent()%></p>
                                ...
                                <form action="EditServlet" method="POST" enctype="multipart/form-data">
                                    <table class="table">
                                        ...
                                        <tr>
                                            ...
                                            <td><textarea rows="3" class="form-contrl" name="user_about"><%=user.getAbout()%></textarea> 
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form  id="add-post-form" action="AddPostServlet" method="POST">
                            ...
                            <div class="form-group">
                                <input name="pSubContent" type="text" placeholder="Describe your topic in more than 250 words" class="form-control"/>
                                </div>
                                     <div class="form-group">
                    ...
                    $("#add-post-form").on("submit", function (event) {
                        ...
                        $.ajax({
                            ...
                            success: function (data, textStatus, jqXHR) {
                                ...
                                console.log(data);
                                if (data.trim() == 'done') {
                                    swal("Good job!", "Save successfilly!", "success");
                                } else {
                                    swal("Error!", "Something went wrong on show!", "error");
                                }
                            },
