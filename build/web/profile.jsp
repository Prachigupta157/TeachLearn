                ...
                <div class="row mt-4">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="list-group">
                            ...
                            <p class="list-group-item "style=" background-color:#e3f2fd" ><%=cc.getDescription()%></p>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form  id="add-post-form" action="AddPostServlet" method="POST">
                            ...
                            <div class="form-group">
                                <input name="pSubContent" type="text" placeholder="Describe your topic in more than 150 words" class="form-control" />
                            </div>
                            <div class="form-group">
                    ...
                    $.ajax({
                        ...
                        success: function (data, textStatus, jqXHR) {
                            ...
                            if (data.trim() == 'done') {
                                ...
                                swal("Error!", "Something went wrong profile!", "error");
